...
###########################
P_1<-64     #población de agentes capa 1 PPPPPPPPPPPPPPPPPPPP
P_2<-5       #población capa 2 P PPPPPPPPPPPPPPPPPPPP
G_2<-5       #generaciones capa 2 PPPPPPPPPPPPPPPPPPPP
Comu<-1       #tipo de comunicación entre poblaciones de la capa 2 PPPPPPPPPPPPPPPPPPPP
Cruz<-0.79    #porcentaje de cruzamiento para duplicar agentes PPPPPPPPPPPPPPPPPPPP
